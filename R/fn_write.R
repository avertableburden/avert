#' Write avert report
#' @description write_avert_report() is a Write function that writes a file to a specified local directory. Specifically, this function implements an algorithm to write avert report. The function is called for its side effects and does not return a value.
#' @param results_ls Results (a list)
#' @param consent_1L_chr Consent (a character vector of length one), Default: ''
#' @param consent_indcs_int Consent indices (an integer vector), Default: 1
#' @param markdown_dir_1L_chr Markdown directory (a character vector of length one), Default: character(0)
#' @param mkdn_source_dir_1L_chr Markdown source directory (a character vector of length one), Default: 'NA'
#' @param options_chr Options (a character vector), Default: c("Y", "N")
#' @param output_dir_1L_chr Output directory (a character vector of length one), Default: character(0)
#' @return No return value, called for side effects.
#' @rdname write_avert_report
#' @export 
#' @importFrom ready4show Ready4showSynopsis
