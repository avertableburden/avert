...
## Run app
The `run_avert_app` function launches a user interface. However, this is intended for use in conjunction with data files that are currently restricted access.
